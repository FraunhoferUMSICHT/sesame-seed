...
from pyomo.environ import Constraint, Binary, NonNegativeReals, Var, Set, Param
...
class StorageBlock(ScalarBlock):
    ...
    def _create(self, group=None):
        ...
        self.P_in_flow = Constraint(
            self.STORAGES, m.TIMESTEPS, rule=_P_in_sum_rule
        )
        ...
        self.P_in_max = Constraint(
            self.STORAGES, m.TIMESTEPS, rule=_P_in_max_rule
        )
        ...
        self.P_out_max = Constraint(
            self.STORAGES, m.TIMESTEPS, rule=_P_out_max_rule
        )
